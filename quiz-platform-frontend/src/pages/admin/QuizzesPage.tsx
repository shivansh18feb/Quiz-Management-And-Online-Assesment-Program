...
const QuizzesPage: React.FC = () => {
  ...
  useEffect(() => {
    const loadQuizzes = async () => {
      try {
        const response = await quizService.getQuizzes(0, 100);
        ...
        <div className="p-4 border-b border-gray-100 dark:border-gray-700 flex gap-4">
          <div className="flex-1 flex items-center bg-gray-50 dark:bg-gray-900 rounded-lg px-3 py-2 border border-gray-200 dark:border-gray-700">
            ...
            <input
              ...
              className="bg-transparent border-none outline-none w-full text-gray-800 dark:text-white"
            />
          </div>
              ...
              {quizzes.map((quiz) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <div>{quiz.durationMinutes} Mins</div>
                  </td>
